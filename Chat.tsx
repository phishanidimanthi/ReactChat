...
import { StyleSheet, Text, TextInput, SafeAreaView, View, Image, FlatList, Alert, TouchableOpacity, ImageBackground } from 'react-native';
...
export function Chat({ route, navigation }) {
  ...
  const image = { uri: 'https://www.techgrapple.com/wp-content/uploads/2016/07/WhatsApp-Chat-theme-iPhone-2.jpg' };
  ...
  const ui = (
    <ImageBackground source={image} style={styles.chatBackGround}>
      ...
      <SafeAreaView style={styles.chat}>
        ...
        <View style={styles.chatSendView}>
          <TextInput style={styles.chatInput1} autoCorrect={false} placeholderTextColor={'#04042C'} placeholder={"Type here..."} onChangeText={setChatText} />
